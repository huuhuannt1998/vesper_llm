...
- `blender/safety_enforcement.py` applies 19 safety rules spanning appliance safety, entry security, sensor integrity, spatial-temporal constraints, and task semantics.
...
- **Safety Logs**: `casas_testbed/vesper_datasets/safety_metrics_{mode}_{trial_id}.json` (default export location)
